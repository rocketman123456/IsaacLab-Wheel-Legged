...
parser.add_argument("--width", type=int, default=1600, help="Width of the viewport and generated images. Defaults to 1280")
parser.add_argument("--height", type=int, default=900, help="Height of the viewport and generated images. Defaults to 720")
