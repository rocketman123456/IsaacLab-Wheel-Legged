...
from wheeled_legged_rl.third_party.rsl_rl_amp.datasets import motion_util, pose3d
from wheeled_legged_rl.third_party.rsl_rl_amp.utils import amp_utils
    ...
    def __init__(
        ...
        for i, motion_file in enumerate(motion_files):
            ...
            with open(motion_file) as f:
                ...
                self.trajectories_full.append(torch.tensor(motion_data[:, : AMPLoader.JOINT_VEL_END_IDX], dtype=torch.float32, device=device))
